...
namespace AssetCache
{
    ...
    public interface IAssetCache
    {
        ...
        /// <param name="interruptChecker">проверка на необходимость прерваться, бросает 'OperationCanceledException' в
        /// случае необходимости прерваться</param>
        ...
        /// Индекс используется для ответа на запросы, представленные ниже
        /// </summary>
        /// <param name="path">Путь к существующему файлу на диске</param>
